$('#menu').append(
		...
		"<li><a href='/sakila/address/city.html'>🌇 도시 관리</a></li>"+
		"<li><a href='/sakila/address/address.html'>🏠 주소 관리</a></li>"+
		"</ul>"+
		...
		"<li><a href='/sakila/business/store.html'>🏤 지점 관리</a></li>"+
		"</ul>"+
		"<p class='menu-label'>Inventory</p>"+
		"<ul class='menu-list'>"+
		"<li><a href='/sakila/inventory/inventory.html'>📉  재고 관리</a></li>"+
		"<li><a href='/sakila/inventory/inventory.html'>🎥  보유 목록</a></li>"+
		"</ul>"+
		"<p class='menu-label'>Setting</p>"+
		"<ul class='menu-list'>"+
		"<li><a href='/sakila/setting/language.html'>🌐 언어 관리</a></li>"+
		"</ul>"+
		"</aside>");
